...
void CGameProcess::GameLoop()
{
	...
	m_pDREngine->DrawText(630, 190, "하얀 타원: 알");
	m_pDREngine->DrawText(630, 210, "연두색 네모: 애벌레");
	m_pDREngine->DrawText(630, 230, "빨간색 네모: 일개미");
	m_pDREngine->DrawText(630, 250, "검붉은 네모: 병정개미");
	m_pDREngine->DrawText(630, 270, "//");
	m_pDREngine->DrawText(630, 290, "검정 타원: 여왕개미");
